...
architecture DEF_ARCH of shift_register is 
  ...
  component VCC
    ...
    signal \q_6_Z[3]\, \q_6_Z[2]\, \q_6_Z[1]\, \q_6_Z[0]\, 
        \parallel_in_c[3]\, \parallel_in_c[2]\, 
        \parallel_in_c[1]\, \parallel_in_c[0]\, \q_c[3]\, 
        \q_c[2]\, \q_c[1]\, \q_c[0]\, \q_6_1_Z[3]\, \q_6_1_Z[2]\, 
        \q_6_1_Z[1]\, \q_6_1_Z[0]\, \GND\, \VCC\, 
        \clk_ibuf_RNIVTI21/U0_YNn\, rst_c, en_c, NN_1, NN_2, 
        serial_in_c, un1_q16_i, ff_to_start_net, 
        \sel_ibuf[0]/U0/YIN1\, \parallel_in_ibuf[3]/U0/YIN1\, 
        \sel_ibuf[1]/U0/YIN1\, clk_ibuf_Z, \clk_ibuf/U0/YIN\, 
        \serial_in_ibuf/U0/YIN1\, \q_obuf[3]/U0/DOUT\, 
        \q_obuf[3]/U0/EOUT\, \q_obuf[1]/U0/DOUT\, 
        \q_obuf[1]/U0/EOUT\, \q_obuf[2]/U0/DOUT\, 
        \q_obuf[2]/U0/EOUT\, \parallel_in_ibuf[0]/U0/YIN1\, 
        \parallel_in_ibuf[1]/U0/YIN1\, \rst_ibuf/U0/YIN1\, 
        \parallel_in_ibuf[2]/U0/YIN1\, \q_obuf[0]/U0/DOUT\, 
        \q_obuf[0]/U0/EOUT\, \en_ibuf/U0/YIN1\, clk_c, AFLSDF_VCC, 
...
begin 
    ...
    \q_6_1[1]\ : CFG4
      ...
      port map(A => NN_2, B => NN_1, C => \q_c[2]\, D => \q_c[0]\, 
        Y => \q_6_1_Z[1]\);
    
    \rst_ibuf/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \rst_ibuf/U0/YIN1\, Y => rst_c);
    
    \parallel_in_ibuf[0]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \parallel_in_ibuf[0]/U0/YIN1\, Y => 
        \parallel_in_c[0]\);
    ...
    \sel_ibuf[1]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => sel(1), Y => \sel_ibuf[1]/U0/YIN1\);
    
    \en_ibuf/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \en_ibuf/U0/YIN1\, Y => en_c);
    
    \q_Z[0]\ : SLE
      port map(D => \q_6_Z[0]\, CLK => clk_c, EN => un1_q16_i, 
        ALn => \AFLSDF_INV_0\, ADn => \VCC\, SLn => \VCC\, SD => 
        \GND\, LAT => \GND\, Q => \q_c[0]\);
    ...
    \sel_ibuf[0]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => sel(0), Y => \sel_ibuf[0]/U0/YIN1\);
    ...
    \parallel_in_ibuf[2]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => parallel_in(2), Y => 
        \parallel_in_ibuf[2]/U0/YIN1\);
    
    \parallel_in_ibuf[1]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \parallel_in_ibuf[1]/U0/YIN1\, Y => 
        \parallel_in_c[1]\);
    
    \parallel_in_ibuf[3]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \parallel_in_ibuf[3]/U0/YIN1\, Y => 
        \parallel_in_c[3]\);
    
    \flash_freeze_inst/INST_FLASH_FREEZE_IP\ : FLASH_FREEZE
      port map(FF_TO_START => ff_to_start_net, FF_DONE => OPEN);
    
    \serial_in_ibuf/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \serial_in_ibuf/U0/YIN1\, Y => serial_in_c);
    ...
    \serial_in_ibuf/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => serial_in, Y => \serial_in_ibuf/U0/YIN1\);
    ...
    \sel_ibuf[0]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \sel_ibuf[0]/U0/YIN1\, Y => NN_1);
    ...
    \q_Z[1]\ : SLE
      port map(D => \q_6_Z[1]\, CLK => clk_c, EN => un1_q16_i, 
        ALn => \AFLSDF_INV_2\, ADn => \VCC\, SLn => \VCC\, SD => 
        \GND\, LAT => \GND\, Q => \q_c[1]\);
    ...
    \q_6_1[2]\ : CFG4
      ...
      port map(A => NN_2, B => NN_1, C => \q_c[3]\, D => \q_c[1]\, 
        Y => \q_6_1_Z[2]\);
    
    \parallel_in_ibuf[2]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \parallel_in_ibuf[2]/U0/YIN1\, Y => 
        \parallel_in_c[2]\);
    
    AFLSDF_INV_1 : INV_BA
      port map(A => clk_ibuf_Z, Y => \AFLSDF_INV_1\);
    
    \parallel_in_ibuf[3]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => parallel_in(3), Y => 
        \parallel_in_ibuf[3]/U0/YIN1\);
    
    \parallel_in_ibuf[1]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => parallel_in(1), Y => 
        \parallel_in_ibuf[1]/U0/YIN1\);
    ...
    \q_Z[3]\ : SLE
      port map(D => \q_6_Z[3]\, CLK => clk_c, EN => un1_q16_i, 
    ...
    \q_Z[2]\ : SLE
      port map(D => \q_6_Z[2]\, CLK => clk_c, EN => un1_q16_i, 
        ALn => \AFLSDF_INV_4\, ADn => \VCC\, SLn => \VCC\, SD => 
        \GND\, LAT => \GND\, Q => \q_c[2]\);
    
    \parallel_in_ibuf[0]/U0/U_IOPAD\ : sdf_IOPAD_IN
      port map(PAD => parallel_in(0), Y => 
        \parallel_in_ibuf[0]/U0/YIN1\);
    ...
    \sel_ibuf[1]/U0/U_IOINFF\ : IOINFF_BYPASS
      port map(A => \sel_ibuf[1]/U0/YIN1\, Y => NN_2);
