...
firmware/drivers/mss_sys_services/%.o: ../firmware/drivers/mss_sys_services/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I"E:\Projects\DRDO\drdo\firmware\CMSIS" -I"E:\Projects\DRDO\drdo\firmware\drivers_config" -I"E:\Projects\DRDO\drdo\firmware\hal" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
